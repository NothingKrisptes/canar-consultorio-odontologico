...
const odontograma_module_1 = require("../odontograma/odontograma.module");
...
exports.PacientesModule = PacientesModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([paciente_entity_1.Paciente]), odontograma_module_1.OdontogramaModule,],
